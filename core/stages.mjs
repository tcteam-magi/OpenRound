/* The three stage-native investors. `file` is relative to the repo root:
   ...
   when you walk in cold, `introOpener` when you arrive warm-introduced by
   another investor, `notedOpener` when the host sent you up with his note
   (an introduction, not an endorsement — the bar doesn't move), `introLine`
   is what they say when you pass (for the last stage it is the close, since
   there is nobody left to introduce you to), and `next` is the stage a pass
   walks you up to. */
...
export const STAGES = [
  {
    ...
    notedOpener: "He texted me, which he does for everybody, so the note told me almost nothing. Good. Tell me yourself: what are you raising?",
  ...
  },
  {
    ...
    notedOpener: "I got his note. He sends me everyone he likes, and he likes everyone. So, from the top: what are you raising?",
  ...
  },
  {
    ...
    notedOpener: "His note said I'd like the numbers. His notes always say that. Show me: what are you raising?",
